# Especificación funcional — Sistema ERP Web para Joyería

Documento de requisitos original del proyecto (antes vivía en `CLAUDE.md`).
Describe el alcance deseado, no necesariamente lo que ya está construido: para
el estado real del código y las reglas operativas vigentes, ver `CLAUDE.md`.
